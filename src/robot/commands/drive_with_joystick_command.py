...
from constants.sharktypes import percentage
from subsystems.drive_subsystem import DriveSubsystem


class DriveWithJoystickCommand(
    commands2.Command
):  # Class type command from the libary command2
    def __init__(
        self,
        drive: DriveSubsystem,
        drive_percent_fn: Callable[[], tuple[percentage, percentage, percentage]],
    ...
    def isFinished(
        self,
    ):  # When something else happends then this is done, cause this is a default command
        return True
