...
from constants.sharktypes import inches_per_second, degrees_per_second
...
class DriveSubsystem(commands2.Subsystem):  # Name what type of class this is
    ...
    def _get_chassis_speeds(
        ...
        if field_relative:
            ...
            cs = ChassisSpeeds(
                x_speed_meters_per_second, y_speed_meters_per_second, rot_speed_radians
            )
        return cs
    ...
    def _get_module_translations(self) -> list[wpimath.geometry.Translation2d]:
        ...
        half_length = metersToInches(
            DriveConstants.WHEELBASE_HALF_LENGTH
        )  # Convert to inches
        half_width = metersToInches(
            DriveConstants.TRACK_HALF_WIDTH
        )  # Convert to inches
